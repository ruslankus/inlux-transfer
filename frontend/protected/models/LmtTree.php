 ...
 */
class LmtTree extends CActiveRecord
{
	/**
	 ...
	 * @return LmtTree the static model class
	 */
    ...
    {
        /* @var $lngObject LmtTreeLng */

        $lngObject = LmtTreeLng::model()->findByAttributes(array('object_id' => $this->id, 'language' => $lng));
        if($lngObject == null)
        {
            $lngObject = new LmtTreeLng();
    ...
    public function deleteLng()
    {
        ...
        $all = LmtTreeLng::model()->findAllByAttributes(array('object_id' => $this->id));
