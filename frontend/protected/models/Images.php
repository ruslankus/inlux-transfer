...
class Images extends CActiveRecord
{
    ...
    {
        /* @var $lngObject ImagesLng */

        $lngObject = ImagesLng::model()->findByAttributes(array('object_id' => $this->id, 'language' => $lng));
        if($lngObject == null)
        {
            $lngObject = new ImagesLng();
    ...
    public function deleteLng()
    {
        ...
        $all = ImagesLng::model()->findAllByAttributes(array('object_id' => $this->id));
