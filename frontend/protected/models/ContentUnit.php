 ...
 */
class ContentUnit extends CActiveRecord
{
	/**
	 ...
	 * @return ContentUnit the static model class
	 */
    ...
    {
        /* @var $lngObject ContentUnitLng */

        $lngObject = ContentUnitLng::model()->findByAttributes(array('object_id' => $this->id, 'language' => $lng));
        if($lngObject == null)
        {
            $lngObject = new ContentUnitLng();
    ...
    public function deleteLng()
    {
        ...
        $all = ContentUnitLng::model()->findAllByAttributes(array('object_id' => $this->id));
