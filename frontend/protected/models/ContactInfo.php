...
class ContactInfo extends CActiveRecord
{
    ...
    {
        /* @var $lngObject ContactInfoLng */

        $lngObject = ContactInfoLng::model()->findByAttributes(array('object_id' => $this->id, 'language' => $lng));
        if($lngObject == null)
        {
            $lngObject = new ContactInfoLng();
    ...
    public function deleteLng()
    {
        ...
        $all = ContactInfoLng::model()->findAllByAttributes(array('object_id' => $this->id));
