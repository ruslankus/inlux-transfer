...
class Tree extends CActiveRecord
{
    ...
    {
        /* @var $lngObject TreeLng */

        $lngObject = TreeLng::model()->findByAttributes(array('object_id' => $this->id, 'language' => $lng));
        if($lngObject == null)
        {
            $lngObject = new TreeLng();
    ...
    public function deleteLng()
    {
        ...
        $all = TreeLng::model()->findAllByAttributes(array('object_id' => $this->id));
