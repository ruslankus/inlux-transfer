 ...
 */
class LmtContactInfo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('label, email_1, email_2, phone_1, phone_2, phone_3, administrator_email, moderator_email, feedback_restricted_ips', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, label, email_1, email_2, phone_1, phone_2, phone_3, administrator_email, moderator_email, feedback_restricted_ips', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return LmtContactInfo the static model class
	 */
    ...
    {
        /* @var $lngObject LmtContactInfoLng */

        $lngObject = LmtContactInfoLng::model()->findByAttributes(array('object_id' => $this->id, 'language' => $lng));
        if($lngObject == null)
        {
            $lngObject = new LmtContactInfoLng();
    ...
    public function deleteLng()
    {
        ...
        $all = LmtContactInfoLng::model()->findAllByAttributes(array('object_id' => $this->id));
