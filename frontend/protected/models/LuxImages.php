 ...
 */
class LuxImages extends CActiveRecord
{
	/**
	 ...
	 * @return LuxImages the static model class
	 */
    ...
    {
        /* @var $lngObject LuxImagesLng */

        $lngObject = LuxImagesLng::model()->findByAttributes(array('object_id' => $this->id, 'language' => $lng));
        if($lngObject == null)
        {
            $lngObject = new LuxImagesLng();
    ...
    public function deleteLng()
    {
        ...
        $all = LuxImagesLng::model()->findAllByAttributes(array('object_id' => $this->id));
