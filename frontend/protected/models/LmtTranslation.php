 ...
 */
class LmtTranslation extends CActiveRecord
{
	/**
	 ...
	 * @return LmtTranslation the static model class
	 */
    ...
    {
        $id = $this->id;
        $lng = LmtTranslationLng::model()->findByAttributes(array('object_id' => $id, 'language' => $strLng));

        if($lng == null)
        {
            $lng = new LmtTranslationLng();
            $lng->object_id = $id;
            $lng->language = $strLng;
            return $lng;
        }
    ...
    {
        $lngObjAll = LmtTranslationLng::model()->findAllByAttributes(array('object_id' => $this->id));
    ...
    {
        /* @var $lng LmtTranslationLng */
        /* @var $lngResult LmtTranslationLng */

        $lng = LmtTranslationLng::model()->findByAttributes(array('language' => $inputLng, 'word' => $str));
        $objId =  $lng->object_id;
        $lngResult = LmtTranslationLng::model()->findByAttributes(array('language' => $outputLng, 'object_id' => $objId));
