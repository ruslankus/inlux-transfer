 ...
 */
class LuxTranslation extends CActiveRecord
{
	/**
	 ...
	 * @return LuxTranslation the static model class
	 */
    ...
    {
        $id = $this->id;
        $lng = LuxTranslationLng::model()->findByAttributes(array('object_id' => $id, 'language' => $strLng));

        if($lng == null)
        {
            $lng = new LuxTranslationLng();
            $lng->object_id = $id;
            $lng->language = $strLng;
            return $lng;
        }
    ...
    {
        $lngObjAll = LuxTranslationLng::model()->findAllByAttributes(array('object_id' => $this->id));
    ...
    {
        /* @var $lng LuxTranslationLng */
        /* @var $lngResult LuxTranslationLng */

        $lng = LuxTranslationLng::model()->findByAttributes(array('language' => $inputLng, 'word' => $str));
        $objId =  $lng->object_id;
        $lngResult = LuxTranslationLng::model()->findByAttributes(array('language' => $outputLng, 'object_id' => $objId));
