 ...
 */
class LuxContentUnit extends CActiveRecord
{
	/**
	 ...
	 * @return LuxContentUnit the static model class
	 */
    ...
    {
        /* @var $lngObject LuxContentUnitLng */

        $lngObject = LuxContentUnitLng::model()->findByAttributes(array('object_id' => $this->id, 'language' => $lng));
        if($lngObject == null)
        {
            $lngObject = new LuxContentUnitLng();
    ...
    public function deleteLng()
    {
        ...
        $all = LuxContentUnitLng::model()->findAllByAttributes(array('object_id' => $this->id));
