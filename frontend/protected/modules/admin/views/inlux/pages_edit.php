...
$cs->registerScriptFile(Yii::app()->baseUrl . '/js/AjexFileManager/ajex.js');
?>
...
<div class="block-container">
    <form action="<?php echo AdminFunctions::GetAdminActionUrl('inlux','updatepage')?>" method="post" enctype="multipart/form-data">

        <?php if($item != null):?>
            <input type="hidden" name="id" value="<?php echo $item->id; ?>">
        <?else: ?>
            <?php $item = new LuxContentUnit(); ?>
        <?php endif; ?>
