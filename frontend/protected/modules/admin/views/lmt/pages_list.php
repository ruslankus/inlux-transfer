...
<div class="block-container">
    ...
    <form method="post" action="<?php echo AdminFunctions::GetAdminActionUrl('lmt','pageslist') ?>">
            ...
            <tr>
                ...
                <td class="td-tbl-clr" style="text-align:center;">
                    ...
                    <?php if($item->status == Constants::STATUS_VISIBLE): ?>
                        <?php echo CHtml::link("Скрыть",'/admin/lmt/statuspage/id/'.$item->id.'/status/'.Constants::STATUS_HIDDEN.$prefix_special,array('class' => 'button hide-btn', 'title' => 'скрыть')); ?>
                    <?php else: ?>
                        <?php echo CHtml::link("Показать",'/admin/lmt/statuspage/id/'.$item->id.'/status/'.Constants::STATUS_VISIBLE.$prefix_special,array('class' => 'button show-btn', 'title' => 'показать')); ?>
                    <?php endif; ?>

                    <?php if($current_tree != null && $current_tree != ''): ?>
                        <?php echo CHtml::link("⇑",'/admin/lmt/orderpage/dir/up/id/'.$item->id.$prefix_special,array('class' => 'button top-arrow', 'title' => 'сдвинуть вверх')); ?>
                        <?php echo CHtml::link("⇓",'/admin/lmt/orderpage/dir/down/id/'.$item->id.$prefix_special,array('class' => 'button bot-arrow', 'title' => 'сдвинуть вниз')); ?>
                    <?php endif;?>

                    <?php echo CHtml::link("Удалить",'/admin/lmt/deletepage/id/'.$item->id.$prefix_special,array('class' => 'button delete-lnk del-link', 'title' => 'удалить')); ?>
                    <?php echo CHtml::link("Изменить",'/admin/lmt/editpage/id/'.$item->id.$$prefix_special,array('class' => 'button edit-lnk', 'title' => 'редактировать')); ?>
    ...
    <br>
    <?php echo CHtml::link("Создать",'/admin/lmt/createpage'.$prefix_special,array('class' => 'button-submit-red red-button-settings')); ?>
