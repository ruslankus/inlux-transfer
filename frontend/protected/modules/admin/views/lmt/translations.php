...
<table class="tbl-cont-list" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td class="td-tbl-clr" style="text-align:center;">
            <?php echo CHtml::link("Удалить",'/admin/lmt/transdel/id/'.$word->id,array('class' => 'button delete-lnk del-link', 'title' => 'удалить')); ?>
            <?php echo CHtml::link("Изменить",'/admin/lmt/transedit/id/'.$word->id,array('class' => 'button edit-lnk', 'title' => 'редактировать')); ?>
        </td>
    </tr>
    <?php endforeach; ?>
...
<br>
    <?php echo CHtml::link("Создать",'/admin/lmt/transcreate',array('class' => 'button-submit-red red-button-settings')); ?>
</div>